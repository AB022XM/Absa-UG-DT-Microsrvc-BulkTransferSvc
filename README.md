...
To build the final jar and optimize the AbsaUGDTMicrobulkTransferSvc application for production, run:
...
Then navigate to [http://localhost:9047](http://localhost:9047) in your browser.
